...
if(isset($_REQUEST['delete'])){
 $sql = "DELETE FROM feedback_details WHERE id= {$_REQUEST['id']}";
...
<html lang="en">
  ...
  <body>
      ...
      <a href="feedback_reg.php" class="float-right btn btn btn-outline-primary mb-3">Add Data</a>
...
<?php
      ...
      echo"<th>Delete</th>";
			...
			echo"<tr>";
			 ...
			 echo "<td>
                  <a href='feedback_update.php?id=".$row["id"]."'  class='btn btn-warning btn-sm'>Edit</a>
                  </td>";
