  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 mt-3">
        <h1 class="text-center text-info">Flat Detail
          Information</h1>
        <a href="flat1.php" class="float-right btn btn btn-outline-primary mb-3">Add
          Data</a>
        <?php
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          echo "<th>Area id(PINCODE)</th>";
          echo "<th>Flat rate</th>";
          echo "<th>Square foot</th>";
          echo "<th>Propery Type</th>";
          ...
          while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>
                  <a href='flat3_update.php?id=" . $row["id"] . "' class='btn btn-warning btn-sm'>Edit</a>
                  </td>";
