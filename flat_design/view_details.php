...
<body>
 <?php
  $sql = "SELECT
 area.name,area.pincode,area.full_address,flat.flat_rate,flat.sq_ft,flat.flat_img_internal,flat.property_type,flat.flat_type,flat.id
 FROM area INNER JOIN flat ON area.pincode=flat.pincode WHERE id='$id'";
