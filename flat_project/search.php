...
<body>
 <div class="container">
  ...
  <div class="form-group">
   <label for="facaulty_name">Search Location</label>
   <select id="pincode" class="form-control" name="pincode">
    <option disabled selected>Please Select location
    </option>
    <?php
           ...
           ?>
    <option value="<?php echo $row['full_address'] ?>">
     <?php echo $row['full_address'] ?></option>
    <?php
           }
           ?>
   </select>
